...
#define OS_MAX_FLAGS             32u   /* Max. number of Event Flag Groups    in your application      */
#define OS_MAX_MEM_PART          64u   /* Max. number of memory partitions                             */
#define OS_MAX_QS                64u   /* Max. number of queue control blocks in your application      */
...
#define OS_TASK_STAT_STK_SIZE   512u   /* Statistics task stack size (# of OS_STK wide entries)        */
#define OS_TASK_IDLE_STK_SIZE   512u   /* Idle       task stack size (# of OS_STK wide entries)        */
#define OS_START_STACK_SIZE    1024u   /* 最高优先级任务的堆栈大小，单位：字 */
...
#define OS_TMR_CFG_WHEEL_SIZE    16u   /*     Size of timer wheel (#Spokes)                            */
#define OS_TMR_CFG_TICKS_PER_SEC 100   /* Rate at which timer management task runs (Hz)                */
#define OS_TASK_TMR_PRIO         (1)   /* TIMER线程的优先级仅次于启动线程(PRIO=0)，以保证定时器准确。  */
