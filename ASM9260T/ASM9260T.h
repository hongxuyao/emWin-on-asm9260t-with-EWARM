...
typedef volatile  u8_t *VP8;
typedef volatile u16_t *VP16;
typedef volatile u32_t *VP32;
...
#define REG_VAL(r)      (((u32_t)(r))+0x00)
#define REG_SET(r)      (((u32_t)(r))+0x04)
#define REG_CLR(r)      (((u32_t)(r))+0x08)
#define REG_TOG(r)      (((u32_t)(r))+0x0C)
...
typedef struct {
  ...
  __IO u32_t CTRL1[4];
  __IO u32_t CTRL2[4];
  __IO u32_t LINECTRL[4];
  __IO u32_t INTR[4];
  __IO u32_t DATA[4];
  __IO u32_t STAT[4];
  __I  u32_t DEBUG[4];
  __IO u32_t ILPR[4];
  __IO u32_t RS485CTRL[4];
  __IO u32_t RS485ADRMATCH[4];
  __IO u32_t RS485DLY[4];
  __IO u32_t AUTOBAUD[4];
  __IO u32_t CTRL3[4];
} ASM_USART_TypeDef;
